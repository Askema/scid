...
new _vendor_swiper__WEBPACK_IMPORTED_MODULE_0___default.a('.swiper', {
    ...
    320: {
      ...
      pagination: {
        ...
        renderFraction: function renderFraction(currentClass, totalClass, index, total) {
          return '<span class="' + currentClass + '"> ' + index + ' </span>' + '<span class="swiper-pagination-of"> ' + 'of' + ' </span>' + '<span class="' + totalClass + '"> ' + total + ' </span>';
        }
      }
    },
    768: {
...
!function (e, t) {
  ...
  var re = [function (e) {
    ...
    function u() {
      ...
      "fraction" === e.type && (r = e.renderFraction ? e.renderFraction.call(t, e.currentClass, e.totalClass) : "<span class=\"".concat(e.currentClass, "\"></span>  of  <span class=\"").concat(e.totalClass, "\"></span>"), a.html(r)), "progressbar" === e.type && (r = e.renderProgressbar ? e.renderProgressbar.call(t, e.progressbarFillClass) : "<span class=\"".concat(e.progressbarFillClass, "\"></span>"), a.html(r)), "custom" !== e.type && i("paginationRender", t.pagination.$el[0]);
    }
